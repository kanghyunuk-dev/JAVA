...
//		System.out.printf("두수의 합 : %s , 두 수의 차 : %s, 두 수의 곱 : %s", plus, minus, multiply);
		
//		System.out.println("합 : " + (num1 + num2));
//		System.out.println("차 : " + ((num1>num2) ? num1 - num2 : num2 - num1));
...
//		
		...
		c = --a + b++; // a는 9, b값은 연산 후 20 , c는 19
		d = a-- + ++b; // 10 + 11 , a값은 연산 후 9
