...
// a.Box<Object> b = new Box<String>(); x
// b.Box<Object> b = (Object) new Box<String>(); x
// c.new Box<String>().setItem(new Object()); x
// d.new Box<String>().setItem("ABC"); o
...
//     a.	Juicer.<Apple>makeJuice(new FruitBox<Fruit>()); x
//     b.	Juicer.<Fruit>makeJuice(new FruitBox<Grape>()); x 
//     c.	Juicer.<Fruit>makeJuice(new FruitBox<Fruit>()); o 
//     d.	Juicer.makeJuice(new FruitBox<Apple>()); o
//     e.	Juicer.makeJuice(new FruitBox<Object>()); x
